...
namespace IdOps.GraphQL
{
    public class AuthorizePersonalAccessTokenAuthoringAttribute : ObjectFieldDescriptorAttribute
    {
        ...
        public AuthorizePersonalAccessTokenAuthoringAttribute(AccessMode mode, bool includeTenantAuth)
        {
            _mode = mode;
            ...
            IObjectFieldDescriptor descriptor, MemberInfo member)
        {
            ...
            {
                descriptor
                    .Authorize(AuthorizationPolicies.Names.PersonalAccessTokenEdit, ApplyPolicy.BeforeResolver);
            }
            else
            {
                descriptor
                    .Authorize(AuthorizationPolicies.Names.PersonalAccessTokenRead, ApplyPolicy.BeforeResolver);
            }
        }
    }
}
