...
namespace IdOps.IdentityServer.Storage.Mongo
{
    public class PersistedGrantRepository : IPersistedGrantRepository
    {
        ...
        public PersistedGrantRepository(IIdentityStoreDbContext dbContext)
        {
            ...
            CancellationToken cancellationToken)
        {
            ...
            return (await _dbContext.PersistedGrants
        ...
        public async Task<PersistedGrant> SaveAsync(
            ...
            CancellationToken cancellationToken)
        {
            await _dbContext.PersistedGrants
                        .ReplaceOneAsync(
                            x => x.Key == entity.Key,
                            entity,
            ...
            CancellationToken cancellationToken)
        {
            ...
            await _dbContext.PersistedGrants.DeleteManyAsync(dbFilter, cancellationToken);
        }
